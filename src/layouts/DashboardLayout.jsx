        ...
        <div className="grid grid-cols-12">
            <div className="col-span-2 bg-gray-800 text-white min-h-screen p-6">
                ...
                <ul>
                    ...
                    <li className="border border-gray-700 rounded p-4 mb-2">
                        <Link to={"/add-event"} className="flex items-center text-gray-300 hover:text-white">
                            <FiPlus className="mr-2" />
                            Add Event
                        </Link>
                    </li>
                    <li className="border border-gray-700 rounded p-4 mb-2">
                        <Link to={"/edit-event"} className="flex items-center text-gray-300 hover:text-white">
